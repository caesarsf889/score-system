...
from PyQt5.QtWidgets import QApplication,QWidget, QRadioButton,QWidget,QCheckBox,QInputDialog,QLineEdit, QPushButton, QMessageBox
...
class MyApp(QMainWindow):
    ...
    def add_member(self):
        add_member = int(self.ui.Number.toPlainText())  
